    ...
    <form class="form-horizontal"  method="POST"  enctype="multipart/form-data">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" name="price" class="form-control" id="price" placeholder="Цена" value="<?= $data->getPrice()?>">
                </div>
            </div>
            <div class="form-group">
                <label for="price" class="col-lg-2 control-label">Промоционална цена</label>
                <div class="col-lg-10">
                    <input type="text" name="promoPrice" class="form-control" id="price" placeholder="Промоционална цена" value="<?= $data->getPromoPrice()?>">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-6">
